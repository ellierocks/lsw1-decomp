...
void NuVecRotateX(struct nuvec_s* dst, struct nuvec_s* src, f32 angle);
void NuVecRotateY(struct nuvec_s* dst, struct nuvec_s* src, f32 angle);
void NuVecRotateZ(struct nuvec_s* dst, struct nuvec_s* src, f32 angle);
