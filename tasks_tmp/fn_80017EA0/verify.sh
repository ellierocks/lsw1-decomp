#!/usr/bin/env bash
# Verification for fn_80017EA0 (0x80017EA0)
#
# Steps:
#   1. Write matching C in the appropriate src/<module>/fn_80017EA0.c
...
#          --target build/GL5E4F/obj/nuanim/fn_80017EA0.o \
#          --symbol fn_80017EA0 \
#          --output /tmp/fn_80017EA0_diff.png
#
#   5. Screenshot the objdiff UI showing 100% match and save to:
#      tasks/fn_80017EA0/match_screenshot.png
#
# Troubleshooting:
