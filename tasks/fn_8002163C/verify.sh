#!/usr/bin/env bash
# Verification for fn_8002163C (0x8002163C)
#
# Steps:
#   1. Write matching C in the appropriate src/<module>/fn_8002163C.c
...
#          --target build/GL5E4F/obj/nuanim/fn_8002163C.o \
#          --symbol fn_8002163C \
#          --output /tmp/fn_8002163C_diff.png
#
#   5. Screenshot the objdiff UI showing 100% match and save to:
#      tasks/fn_8002163C/match_screenshot.png
#
# Troubleshooting:
