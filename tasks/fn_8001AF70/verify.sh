#!/usr/bin/env bash
# Verification for fn_8001AF70 (0x8001AF70)
#
# Steps:
#   1. Write matching C in the appropriate src/<module>/fn_8001AF70.c
...
#          --target build/GL5E4F/obj/nuanim/fn_8001AF70.o \
#          --symbol fn_8001AF70 \
#          --output /tmp/fn_8001AF70_diff.png
#
#   5. Screenshot the objdiff UI showing 100% match and save to:
#      tasks/fn_8001AF70/match_screenshot.png
#
# Troubleshooting:
