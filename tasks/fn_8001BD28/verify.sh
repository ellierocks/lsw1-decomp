#!/usr/bin/env bash
# Verification for fn_8001BD28 (0x8001BD28)
#
# Steps:
#   1. Write matching C in the appropriate src/<module>/fn_8001BD28.c
...
#          --target build/GL5E4F/obj/nuanim/fn_8001BD28.o \
#          --symbol fn_8001BD28 \
#          --output /tmp/fn_8001BD28_diff.png
#
#   5. Screenshot the objdiff UI showing 100% match and save to:
#      tasks/fn_8001BD28/match_screenshot.png
#
# Troubleshooting:
