#!/usr/bin/env bash
# Verification for fn_8001FAB8 (0x8001FAB8)
#
# Steps:
#   1. Write matching C in the appropriate src/<module>/fn_8001FAB8.c
...
#          --target build/GL5E4F/obj/nuanim/fn_8001FAB8.o \
#          --symbol fn_8001FAB8 \
#          --output /tmp/fn_8001FAB8_diff.png
#
#   5. Screenshot the objdiff UI showing 100% match and save to:
#      tasks/fn_8001FAB8/match_screenshot.png
#
# Troubleshooting:
