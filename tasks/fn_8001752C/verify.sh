#!/usr/bin/env bash
# Verification for fn_8001752C (0x8001752C)
#
# Steps:
#   1. Write matching C in the appropriate src/<module>/fn_8001752C.c
...
#          --target build/GL5E4F/obj/nuanim/fn_8001752C.o \
#          --symbol fn_8001752C \
#          --output /tmp/fn_8001752C_diff.png
#
#   5. Screenshot the objdiff UI showing 100% match and save to:
#      tasks/fn_8001752C/match_screenshot.png
#
# Troubleshooting:
