#!/usr/bin/env bash
# Verification for fn_80018E64 (0x80018E64)
#
# Steps:
#   1. Write matching C in the appropriate src/<module>/fn_80018E64.c
...
#          --target build/GL5E4F/obj/nuanim/fn_80018E64.o \
#          --symbol fn_80018E64 \
#          --output /tmp/fn_80018E64_diff.png
#
#   5. Screenshot the objdiff UI showing 100% match and save to:
#      tasks/fn_80018E64/match_screenshot.png
#
# Troubleshooting:
