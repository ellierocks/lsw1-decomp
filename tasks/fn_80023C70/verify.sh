#!/usr/bin/env bash
# Verification for fn_80023C70 (0x80023C70)
#
# Steps:
#   1. Write matching C in the appropriate src/<module>/fn_80023C70.c
...
#          --target build/GL5E4F/obj/nuanim/fn_80023C70.o \
#          --symbol fn_80023C70 \
#          --output /tmp/fn_80023C70_diff.png
#
#   5. Screenshot the objdiff UI showing 100% match and save to:
#      tasks/fn_80023C70/match_screenshot.png
#
# Troubleshooting:
