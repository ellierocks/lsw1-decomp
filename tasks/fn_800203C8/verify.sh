#!/usr/bin/env bash
# Verification for fn_800203C8 (0x800203C8)
#
# Steps:
#   1. Write matching C in the appropriate src/<module>/fn_800203C8.c
...
#          --target build/GL5E4F/obj/nuanim/fn_800203C8.o \
#          --symbol fn_800203C8 \
#          --output /tmp/fn_800203C8_diff.png
#
#   5. Screenshot the objdiff UI showing 100% match and save to:
#      tasks/fn_800203C8/match_screenshot.png
#
# Troubleshooting:
