#!/usr/bin/env bash
# Verification for fn_80023F80 (0x80023F80)
#
# Steps:
#   1. Write matching C in the appropriate src/<module>/fn_80023F80.c
...
#          --target build/GL5E4F/obj/nuanim/fn_80023F80.o \
#          --symbol fn_80023F80 \
#          --output /tmp/fn_80023F80_diff.png
#
#   5. Screenshot the objdiff UI showing 100% match and save to:
#      tasks/fn_80023F80/match_screenshot.png
#
# Troubleshooting:
